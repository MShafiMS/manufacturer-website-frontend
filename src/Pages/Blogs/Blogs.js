...
const Blogs = () => {
  return (
    <div className="mx-4">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10 lg:mx-10">
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title mx-auto text-secondary">How will you improve the performance of a React Application?</h2>
            <p>Performance-related problems in web app is not new. Developers have been encountering these issues since a longer period of time. Here's why when any new language originates, developers are bound to face performance issues with it. React is one such example of language. It boasts of a DOM which is very fast. Fast in a way that sometimes, it makes many irrelevant components render the tree. This makes a UI glitch and sometimes developers gets hesitant to continue with the language. However, there are some ways through which developers can solve the performance related problems in React based web app. Let's explore some of these in this article. React Performance – 13 Ways to Optimize Performance of your React App React is one such example of UI framework which is considered best in terms of rendering performance. Although, since it’s virtual DOM is famous for effectively rendering components, it’s still possible to run into performance issues in medium to large web applications</p>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title mx-auto text-secondary">How does prototypical inheritance work?</h2>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title mx-auto text-secondary">You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
            <p>This is find method.I will solve this situation by find method.The find() method returns the value of the first element that passes a test. The find() method executes a function for each array element. The find() method returns undefined if no elements are found.The find method executes the callbackFn function once for each index of the array until the callbackFn returns a truthy value. If so, find immediately returns the value of that element. Otherwise, find returns undefined. callbackFn is invoked for every index of the array, not just those with assigned values. This means it may be less efficient for sparse arrays, compared to methods that only visit assigned values. If a thisArg parameter is provided to find, it will be used as the this value inside each invocation of the callbackFn. If it is not provided, then undefined is used. The find method does not mutate the array on which it is called, but the function provided to callbackFn can. If so, the elements processed by find are set before the first invocation of callbackFn.</p>
            <div className="card-actions justify-end">
            </div>
          </div>
        </div>
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title mx-auto text-secondary">What is a unit test? Why should write unit tests?</h2>
